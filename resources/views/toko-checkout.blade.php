                        ...
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Kode Unik</td>
                                    <td>:</td>
                                    <td style="text-align:left;">{{ $checkout->kode_unik }}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    ...
                                    <td><strong>Total Bayar</strong></td>
                                    <td>:</td>
                                    <td id="total_bayar" style="text-align:left;">
                                        <strong>
                                            @if(isset($pengiriman) && $pengiriman)
                                            Rp {{ number_format($pengiriman->ongkir + $checkout->grand_total + $checkout->kode_unik) }}
                                            @else
                                            Rp {{ number_format($checkout->grand_total + $checkout->kode_unik) }}
                                            @endif
                                        </strong>
                                    </td>
                                </tr>
