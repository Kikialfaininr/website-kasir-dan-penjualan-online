...
<head>
    ...
    <link rel="icon" href="{{ asset('img/logo1.png') }}" type="image">

    <!-- My Own Styles -->
    <link rel="stylesheet" type="text/css" href="{{ asset('css\style-kasir.css') }}">
        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/logo1.png') }}" alt="apotek" width="100px"
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                ...
                                @else
                                <img src="{{ asset('img/profil.jpg') }}" alt="profil"
                                    style="width:40px; height: 40px;"
                                    class="d-inline-block align-text-center rounded-circle">
                                @endif
                                {{ Auth::user()->name }}
