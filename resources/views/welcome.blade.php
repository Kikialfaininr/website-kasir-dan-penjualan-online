...
<div class="content title"
    style="background-image: linear-gradient(to right, #34455B, rgba(52, 69, 91, 0)), url('img/bg.jpg'); margin-top: -25px; border-radius: 0 0 50% 20%;">
...
<div class="container container-receipt">
    <div class="row">
        ...
        <div class="col thrid receipt-img">
            <img src="{{ asset('img/apotek-online.jpg') }}" class="receipt-image" />
        </div>
    </div>
</div>
