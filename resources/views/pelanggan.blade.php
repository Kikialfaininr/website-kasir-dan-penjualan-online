...
<div class="container">
    ...
    <div class="row">
        <div class="col" align="center">
            ...
            @else
            <img src="img/profil.jpg" alt="profil" style="width:100px; height: 100px;"
                class="d-inline-block align-text-center rounded-circle">
            @endif
            <h4>{{$value->name}}</h4>
                                ...
                                <table id="example1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">{{$value->kode_unik}}</td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #EEEEEE"><strong>Rp
                                    {{ number_format($kirim->ongkir + $value->grand_total + $value->kode_unik) }}</strong>
                            </td>
                        </tr>
                        @endif
                        @endforeach
                ...
                <form method="POST" action="{{url('update-pelanggan/'.$value->id)}}" enctype="multipart/form-data">
                    ...
                    <div align="center" style="margin-bottom: 20px;">
                        ...
                        <img id="preview" src="{{ asset('images/fotoprofil/'.$value->foto) }}" alt="profil"
                            ...
                            class="d-inline-block align-text-center rounded-circle" />
                        @else
                        <img id="preview" src="{{ asset('img/profil.jpg') }}" alt="profil"
